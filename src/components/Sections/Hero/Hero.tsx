                ...
                <Grid item xs={12} sm={10} md={8} lg={7}>
                    <Box ref={ref}>
                        ...
                        <Typography
                           ...
                           Hey there! Call me Mahmoud Bannouri. I enjoy making and exploring kickass websites and desktop apps while learning new stuff, ones that suit your desires and needs using latest technologies . 
                        </Typography>
                    ...
                    <Box
                        ...
                        <Box
                            ...
                            layout='fill'
                                ...
                                className='img1'
                                src={`https://res.cloudinary.com/dqvlxyfhh/image/upload/v1732016979/image_pro_2_d6d98g.jpg`}
                                alt="Personal Image"/>
                            <Box
