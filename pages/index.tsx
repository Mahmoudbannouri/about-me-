...
const Home : NextPage = ({projectsArray, iconsArray} : any) => {
    ...
    return (
        <Layout desc={`Mahmoud bannouri, A tunisian software engineer student in tunis, Can develop all kinds of websites and web applications according to your needs`} title='Mahmoud Bannouri Fullstack Developer Personal Portfolio Website'>
