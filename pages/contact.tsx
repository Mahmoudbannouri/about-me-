...
const Contact = () => {
    ...
    return (
        <Layout
            title='Mahmoud bannouri contact page'
            desc='If you have questions or need help you can contact me at bannourimahmoud67@gmail.com .'>
                ...
                <Container
                    ...
                    <Box
                        ...
                        <Box sx={{
                            ...
                            <ContactBox 
                            href='mailto:bannourimahmoud67@gmail.com'
                            target='_blank'
                            t1='Get in touch' t2='Email Address' t3='bannourimahmoud67@gmail.com'/>
                            <ContactBox 
                            ...
                            target='_blank'
                            t1='Location'
                             t2='Currently living in' t3='Tunisia/tunis'/>
                            <ContactBox 
                            target='_blank'
                            href={'https://wa.me/96181826445'}
                            t1='Contact Directly ' t2='Phone Number' t3='+216/ 94452482'/>
                        </Box>
                    </Box>
                    <SocialMedia/>
